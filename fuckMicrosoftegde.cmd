...
REM ping www.google.nl -n 1 -w 1000 |>nul find /i "TTL=" && goto CheckUpdate
REM echo                  Невозможно проверить обновления программы, отсутствует интернет
REM echo.
REM echo    Использование старых версий не рекомендуется, поэтому при первой возможности обновите программу
REM pause>nul 
REM cls 
REM goto MainMenu
Проверка обновлений программы
REM :CheckUpdate
REM curl -g -k -L -# -o "%temp%\Version.bat" "https://pastebin.com/raw/udrSrrYN" >nul 2>&1
REM call "%temp%\Version.bat"
REM if "%Thisversion%" lss "%Version%" (goto Update) else (goto MainMenu)
Обновление программы
REM :Update
REM curl -g -k -L -# -o %0 "https://github.com/Enable32/MyProgramm/raw/main/fuckMicrosoftegde.cmd" >nul 2>&1 & call %0
REM exit
...
set edgeupdate=.
set WarpJITSvc=.
echo Версия программы: & call :EchoColor "%Thisversion%" Green & echo.
echo. 
